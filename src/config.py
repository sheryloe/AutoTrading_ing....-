...
class Settings:
    ...
    def from_mapping(cls, data: dict[str, Any]) -> "Settings":
        ...
        settings = cls(
            ...
            google_trend_interval_seconds=max(60, _to_int(data.get("GOOGLE_TREND_INTERVAL_SECONDS"), 600)),
            google_trend_cooldown_seconds=max(60, _to_int(data.get("GOOGLE_TREND_COOLDOWN_SECONDS"), 10800)),
