...
export function normalizeRuntimeConfig(raw = {}) {
  ...
  return {
    ...
    CRYPTO_DERIV_DATA_ENABLED: toBool(
      raw.CRYPTO_DERIV_DATA_ENABLED,
      DEFAULT_RUNTIME_CONFIG.CRYPTO_DERIV_DATA_ENABLED
    ),
    CRYPTO_DERIV_SOURCES: String(
      raw.CRYPTO_DERIV_SOURCES || DEFAULT_RUNTIME_CONFIG.CRYPTO_DERIV_SOURCES
    ).toLowerCase(),
    CRYPTO_DERIV_CACHE_SECONDS: toInt(
      raw.CRYPTO_DERIV_CACHE_SECONDS,
      DEFAULT_RUNTIME_CONFIG.CRYPTO_DERIV_CACHE_SECONDS,
      15,
      600
    ),
